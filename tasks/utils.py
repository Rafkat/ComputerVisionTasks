...
def calculate_mAP(det_boxes, det_labels, det_scores, true_boxes, true_labels, label_map, rev_label_map):
    ...
    for c in range(1, n_classes):
        ...
        for d in range(n_class_detections):
            ...
            original_ind = \
                torch.LongTensor(range(true_class_boxes.size(0))).to(device)[true_class_images == this_image][ind]
